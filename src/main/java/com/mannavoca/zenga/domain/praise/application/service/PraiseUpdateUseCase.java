...
public class PraiseUpdateUseCase {
    ...
    public void choosePraise(ChooseMemberPraiseRequestDto chooseMemberPraiseRequestDto) {
        ...
        MemberPraise memberPraiseById = memberPraiseService.findMemberPraiseById(chooseMemberPraiseRequestDto.getMemberPraiseId());

        memberPraiseService.updatePraisedMemberToMemberPraise(memberPraiseById, praisedMember);
    }
}
