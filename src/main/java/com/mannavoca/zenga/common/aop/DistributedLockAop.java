package com.mannavoca.zenga.common.aop;
...
public class DistributedLockAop {
	...
	@Around("@annotation(com.mannavoca.zenga.common.annotation.DistributedLock)")
	public Object lock(final ProceedingJoinPoint joinPoint) throws Throwable {
		...
		RLock rLock = redissonClient.getFairLock(key);  // (1)
